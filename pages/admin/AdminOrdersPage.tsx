        ...
        >
            ...
            >
                ...
                <div className="space-y-2 text-sm">
                    ...
                    <p><span className="font-semibold text-gray-600">Estado:</span> {order.state}</p>
                    ...
                    <p><span className="font-semibold text-gray-600">Total:</span> ${order.total.toFixed(2)} MXN</p>
